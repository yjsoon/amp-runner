...
- Per-project locks serialise service changes; a global lock prevents start/stop races with uninstall.
...
Tests use temporary homes and a test-only metadata/service-generation mode; they do not invoke launchd, systemd, or Amp.
